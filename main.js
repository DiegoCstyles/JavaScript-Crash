// ATTENTION: THIS CODE IS ONLY FOR LEARNING PURPOSES //
...
// DATA TYPES - String, Bumber, Boolean, null, undefined
const name = 'Brad';
const age = 37;
const rating = 3.5;
const isCool = true;
...
nameInput.addEventListener('input', e => {
	document.querySelector('.container'.append(nameInpit.value));
})
